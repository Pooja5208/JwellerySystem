...
<img align="bottom" src="Images/grt-gold-jewellers-logo.png" vspace=0/>
...
<%
out.println("<a href=diamond.jsp?subtypename="+str+">"+str+"</a>");
%>
</td>
</tr>
...
ResultSet rs1=st.executeQuery("select * from ProductMaster where subtype like('"+request.getParameter("subtypename")+"') and typename like 'di%'");
if(request.getParameter("subtypename")==null)
{
%>

<center> <img src="Images/diamond-jewellery-collections.jpg"/>  </center>
<br>
<%
}
else
{
%>
<center> <img src="Images/diamond-jewellery-collections.jpg" align=left height=200 width=200/>  </center>
<%
