...
<%
out.println("<a href=platinum.jsp?subtypename="+str+">"+str+"</a>");
%>
</td>
</tr>
...
ResultSet rs1=st.executeQuery("select * from ProductMaster where subtype like('"+request.getParameter("subtypename")+"') and typename like 'pl%'");
if(request.getParameter("subtypename")==null)
{
%>

<center> <img src="Images/new-design-gold.jpg"/>  </center>
<br>
<%
}
else
{
%>
<center> <img src="Images/new-design-gold.jpg" align=left height=200 width=200/>  </center>
<%
