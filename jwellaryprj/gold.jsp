...
<jsp:include page="top.jsp"/><div style="float:left;text-align:center"><img align="bottom" src="Images/grt-gold-jewellers-logo.png"/>
<br><br>
<center>
...
<%
out.println("<a href=gold.jsp?subtypename="+str+">"+str+"</a>");
%>
</td>
</tr>
...
ResultSet rs1=st.executeQuery("select * from ProductMaster where subtype like('"+request.getParameter("subtypename")+"') and typename like 'go%'");
if(request.getParameter("subtypename")==null)
{
%>

<center> <img src="Images/gg.jpg"/>  </center>
<br>
<%
}
else
{
%>
<center> <img src="Images/gg.jpg" align=left height=200 width=200/>  </center>
<%
